...
statusbar = ttk.Label(
    root, text="MP3 player", anchor=W, font='Arial 10 bold')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(
    root, text="MP3 player", anchor=W, font='Arial 10 bold')
...
ltframe = Frame(root, bg="#00ffbb")
ltframe.pack(side=LEFT, padx=40, pady=40)
songplaylistcontainer = Listbox(ltframe, fg='black')
songplaylistcontainer["bg"] = "#00ffbb"
...
root.style.configure('TButton', background='#adadad')
rtframe = Frame(root, bg="#00ffbb")
rtframe.pack(pady=30, padx=20)
topframe = Frame(rtframe, bg="#00ffbb")
topframe.pack()
root.style = ttk.Style()
# root.style.theme_use("clam")
root.style.configure('TLabel', background='#00ffbb')
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror(
                'File not found', 'Music player could not find the file. Please select again.')
...
middleframe = Frame(rtframe, bg="#00ffbb")
...
bottomframe = Frame(rtframe, bg="light gray")
